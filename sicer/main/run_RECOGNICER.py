...
from utility import convert_summary_to_bed
from utility import filter_raw_tags_by_islands
...
def main(args, df_run = False):  #df_run indicates if run_RECOGNICER is being called by run_RECOGNICER_df function.
	...
	# #Step 9
	# #Final output
	# print("Convert island summary to island bed file of format chrom start end ChIP-read-count")
	# convert_summary_to_bed.main(fdr_significant_island_output)
	#Step 10
	#Final output
	#print("Filter reads with identified significant islands")
	#filter_raw_tags_by_islands.main(args,processed_treatment_file,fdr_significant_island_output)
